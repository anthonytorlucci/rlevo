...
References are listed alphabetically by first author's surname. Short citation
keys (e.g. `[Sutton and Barto, 2018]`) match the inline citations in the text.

**[Back, 1996]** Back, T. (1996). *Evolutionary Algorithms in Theory and Practice*.
...
**[Eshelman and Schaffer, 1993]** Eshelman, L. J., & Schaffer, J. D. (1993).
...
**[Fujimoto et al., 2018]** Fujimoto, S., van Hoof, H., & Meger, D. (2018).
Addressing function approximation error in actor-critic methods. *Proceedings of
ICML*, 1587–1596.

**[Haarnoja et al., 2018]** Haarnoja, T., Zhou, A., Abbeel, P., & Levine, S.
(2018). Soft actor-critic: Off-policy maximum entropy deep reinforcement learning
with a stochastic actor. *Proceedings of ICML*, 1861–1870. arXiv:1801.01290.

**[Hansen and Ostermeier, 2001]** Hansen, N., & Ostermeier, A. (2001). Completely
derandomized self-adaptation in evolution strategies. *Evolutionary Computation*,
9(2), 159–195.
...
**[Kauffman, 1993]** Kauffman, S. A. (1993). *The Origins of Order:
Self-Organization and Selection in Evolution*. Oxford University Press.

**[Khadka and Tumer, 2018]** Khadka, S., & Tumer, K. (2018). Evolution-guided
policy gradient in reinforcement learning. *Advances in Neural Information
Processing Systems*, 31. arXiv:1805.07917.

**[Koza, 1992]** Koza, J. R. (1992). *Genetic Programming: On the Programming of
Computers by Means of Natural Selection*. MIT Press.

**[Larrañaga and Lozano, 2002]** Larrañaga, P., & Lozano, J. A. (Eds.). (2002).
*Estimation of Distribution Algorithms: A New Tool for Evolutionary Computation*.
Kluwer.

**[Lehman and Stanley, 2011]** Lehman, J., & Stanley, K. O. (2011). Abandoning
...
**[Moriarty and Miikkulainen, 1996]** Moriarty, D. E., & Miikkulainen, R. (1996).
Efficient reinforcement learning through symbiotic evolution. *Machine Learning*,
22, 11–32.

**[Moscato, 1989]** Moscato, P. (1989). On evolution, search, optimization,
genetic algorithms and martial arts: Towards memetic algorithms. Caltech
Concurrent Computation Program, Tech. Report 826.
...
**[Simon, 2013]** Simon, D. (2013). *Evolutionary Optimization Algorithms:
Biologically Inspired and Population-Based Approaches to Computer Intelligence*.
Wiley.

**[Sörensen, 2015]** Sörensen, K. (2015). Metaheuristics — the metaphor exposed.
*International Transactions in Operational Research*, 22(1), 3–18.

**[Stanley and Miikkulainen, 2002]** Stanley, K. O., & Miikkulainen, R. (2002).
Evolving neural networks through augmenting topologies. *Evolutionary
Computation*, 10(2), 99–127.

**[Storn and Price, 1997]** Storn, R., & Price, K. (1997). Differential evolution
— a simple and efficient heuristic for global optimization over continuous
spaces. *Journal of Global Optimization*, 11, 341–359.

**[Such et al., 2017]** Such, F. P., Madhavan, V., Conti, E., Lehman, J.,
Stanley, K. O., & Clune, J. (2017). Deep neuroevolution: Genetic algorithms are a
competitive alternative for training deep neural networks for reinforcement
learning. arXiv:1712.06567.

**[Sutton et al., 1999]** Sutton, R. S., McAllester, D. A., Singh, S. P., &
Mansour, Y. (1999). Policy gradient methods for reinforcement learning with
function approximation. *Advances in Neural Information Processing Systems*, 12.
...
Lanctot, M., & de Freitas, N. (2016). Dueling network architectures for deep
reinforcement learning. *Proceedings of ICML*, 1995–2003.

**[Watkins, 1989]** Watkins, C. J. C. H. (1989). *Learning from Delayed Rewards*
(PhD thesis). University of Cambridge.

**[Watkins and Dayan, 1992]** Watkins, C. J. C. H., & Dayan, P. (1992).
Q-learning. *Machine Learning*, 8(3–4), 279–292.

**[Williams, 1992]** Williams, R. J. (1992). Simple statistical
gradient-following algorithms for connectionist reinforcement learning. *Machine
Learning*, 8(3–4), 229–256.

**[Wolpert and Macready, 1997]** Wolpert, D. H., & Macready, W. G. (1997). No
