...
//! one is specified. Consumers should use [`JsonReporter`] and [`checkpoint`]
//! for the report-persistence paths that ship today.
//!
//! [`BenchmarkReport`]: crate::report::BenchmarkReport
//! [`JsonReporter`]: crate::reporter::json::JsonReporter
