...
impl LunarLanderObservation {
    ...
    pub fn vx(&self) -> f32 { self.values[2] }
    pub fn vy(&self) -> f32 { self.values[3] }
    pub fn angle(&self) -> f32 { self.values[4] }
    pub fn angular_vel(&self) -> f32 { self.values[5] }
    pub fn leg1_contact(&self) -> f32 { self.values[6] }
    pub fn leg2_contact(&self) -> f32 { self.values[7] }
