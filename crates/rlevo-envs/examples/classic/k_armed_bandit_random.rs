...
//!
//! ```bash
//! cargo run -p rlevo-envs --example k_armed_bandit_random
//! ```
...
use rlevo_envs::classic::{KArmedBandit, KArmedBanditAction, KArmedBanditConfig};
...
fn main() {
    ...
    println!("Mean reward per step:               {:+.3}", total_reward / NUM_STEPS as f32);
}
